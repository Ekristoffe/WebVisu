  ...
  if (["polygon", "bezier", "polyline"].includes(shape)) {
    ...
    let polyShapeBasis: IPolyShape = {
      ...
      enable_text_input: util.stringToBoolean(
        section.getElementsByTagName("enable-text-input")[0].innerHTML
      ),
      points: [] as number[][],
      // Optional properties
      tooltip:
    ...
    if (section.getElementsByTagName("enable-text-input").length) {
      if (
        section.getElementsByTagName("enable-text-input")[0].innerHTML == "true"
      ) {
